...
{
    /** @var intlist The skill ID list separated by semicolon (;). Use the 'all' value to select all skills */
    public $skill_id;

    /** @var stringlist The skill name list separated by semicolon (;). Can be used instead of skill_id */
    public $skill_name;
    ...
    /** @var stringlist The ACD queue name that can be used instead of acd_queue_id. The ACD queue name list separated by semicolon (;) */
