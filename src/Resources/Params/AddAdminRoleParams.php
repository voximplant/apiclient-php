...
class AddAdminRoleParams
{
    ...
    /** @var intlist The admin role ID list separated by semicolons (;). Use the 'all' value to select all admin roles. The list specifies the roles from which the new role automatically copies all permissions (allowed_entries and denied_entries) */
    ...
    /** @var stringlist The list of allowed access entries separated by semicolons (;) (the API function names) */
    public $allowed_entries;

    /** @var stringlist The list of denied access entries separated by semicolons (;) (the API function names) */
