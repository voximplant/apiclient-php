...
class SQ_UnbindSkillParams
{
    ...
    /** @var intlist List of skill IDs separated by semicolons (;). Use 'all' to unbind all the skills */
    public $sq_skill_id;

    /** @var stringlist List of skill names separated by semicolons (;). Can be used instead of sq_skill_id */
