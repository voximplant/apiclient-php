...
{
    /** @var string The SenderID for outbound SMS. Please contact support for installing a SenderID */
    public $src_number;

    /** @var stringlist The destination phone numbers separated by semicolon (;). The maximum number of these phone numbers is 100 */
    public $dst_numbers;
