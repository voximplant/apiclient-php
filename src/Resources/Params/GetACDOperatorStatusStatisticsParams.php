...
class GetACDOperatorStatusStatisticsParams
{
    ...
    /** @var stringlist The ACD status list separated by semicolon (;). The following values are possible: OFFLINE, ONLINE, READY, BANNED, IN_SERVICE, AFTER_SERVICE, TIMEOUT, DND */
    public $acd_status;

    /** @var stringlist The user ID list separated by semicolon (;). Use the 'all' value to select all users */
    public $user_id;
