...
class SetRuleInfoParams
{
    ...
    /** @var string The new rule name. The length should be less than 100 */
    public $rule_name;

    /** @var string The new rule pattern regex. The length should be less than 64 KB */
    public $rule_pattern;

    /** @var string The new exclude pattern regex. The length should be less than 64 KB */
