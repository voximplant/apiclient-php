...
class SetAccountInfoParams
{
    ...
    /** @var string The new account password. Should be at least 8 characters long and contain at least one uppercase and lowercase letter, one number, and one special character */
