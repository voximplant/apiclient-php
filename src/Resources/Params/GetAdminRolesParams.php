...
class GetAdminRolesParams
{
    ...
    /** @var intlist The attached admin user ID list separated by the ';' symbol or the 'all' value. */
    public $included_admin_user_id;

    /** @var intlist The not attached admin user ID list separated by the ';' symbol or the 'all' value. */
