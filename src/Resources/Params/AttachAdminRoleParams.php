...
class AttachAdminRoleParams
{
    ...
    /** @var intlist The role(s) ID created via Managing Admin Roles methods. The attached admin role ID list separated by the ';' symbol. Use the 'all' value to select alladmin roles */
