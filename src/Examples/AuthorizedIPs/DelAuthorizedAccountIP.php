 ...
 * authorized_ip - The authorized IP4 or network to remove. Set to 'all' to remove all items. Required unless contains_ip is provided.
 * contains_ip - Specify the parameter to remove the networks that contains the particular IP4. Required unless authorized_ip is provided.
