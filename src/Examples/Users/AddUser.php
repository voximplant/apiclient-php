 ...
 * application_id - The application ID which a new user is to be bound to. Can be used instead of the application_name parameter
 * application_name - The application name which a new user is to be bound to. Can be used instead of the application_id parameter
