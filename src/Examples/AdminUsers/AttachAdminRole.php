 ...
 * required_admin_user_id - The admin user ID list separated by semicolons (;). Use the 'all' value to select all admin users
 * required_admin_user_name - The admin user name to bind, can be used instead of required_admin_user_id
 * admin_role_id - The role(s) ID created via Managing Admin Roles methods. The attached admin role ID list separated by semicolons (;). Use the 'all' value to select alladmin roles
