...
/**
 * @method GetSmartQueueDayHistory Gets the metrics for the specified SmartQueue for the last 2 days. Refer to the <a href="/docs/guides/contact-center/reporting">SmartQueue reporting guide</a> to learn more.
 */
...
use Voximplant\Resources\Params\GetSmartQueueDayHistoryParams;
 ...
 * application_id - The application ID to search by. Required unless application_name is provided.
 * application_name - The application name to search by. Required unless application_id is provided.
 ...
 */
$params = new GetSmartQueueDayHistoryParams();

$params->application_id = 1;
$params->report_type = 'sum_agents_online_time';

// Get the time agents spent in the ONLINE status for all SmartQueues within one application.
$result = $voxApi->SmartQueue->GetSmartQueueDayHistory($params);
