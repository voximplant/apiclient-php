...
/**
 * @method RequestSmartQueueHistory Gets history for the specified smart queue.
 */
 ...
 * user_name - The user name list separated by semicolon (;). Can be used instead of user_id
