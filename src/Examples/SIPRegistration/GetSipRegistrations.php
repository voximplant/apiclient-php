 ...
 * application_id - The application ID list separated by semicolon (;) to filter. Can be used instead of application_name
 * application_name - The application name list separated by semicolon (;) to filter. Can be used instead of application_id
 * is_bound_to_application - Is a SIP registration bound to an application
 * rule_id - The rule ID list separated by semicolon (;) to filter. Can be used instead of rule_name
 * rule_name - The rule name list separated by semicolon (;) to filter. Can be used instead of rule_id
 * user_id - The user ID list separated by semicolon (;) to filter. Can be used instead of user_name
 * user_name - The user name list separated by semicolon (;) to filter. Can be used instead of user_id
