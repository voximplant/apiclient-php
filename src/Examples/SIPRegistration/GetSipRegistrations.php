 ...
 * application_id - The application ID list to filter. Can be used instead of application_name
 * application_name - The application name list to filter. Can be used instead of application_id
