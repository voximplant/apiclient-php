...
class Errors extends Enum
{
     ...
     * Billing failed
     */
    const BILLING_ERROR = 5;
    /**
     * Cannot generate the unique 'api_key'
     */
    const API_KEY_GENERATION_FAILURE = 6;
    /**
     * Activation mail error
     */
    const ACTIVATION_MAIL_ERROR = 9;
    /**
     * Cannot generate the unique 'session_id'
     */
    const SESSION_ID_GENERATION_ERROR = 10;
    /**
     * Invalid 'func_name' parameter
     */
    const INVALID_FUNC_NAME = 12;
    /**
     * The 'config' table error
     */
    const INTERNAL_CONFIGURATION_ERROR = 13;
    /**
     * SMS gateway error
     */
    const SMS_GATEWAY_ERROR = 14;
    /**
     * Media server error
     */
    const MEDIA_SERVER_ERROR = 15;
    /**
     * Media balancer error
     */
    const MEDIA_BALANCER_ERROR = 16;
    /**
     * Paypoint failed
     */
    const PAYPOINT_ERROR = 17;
    /**
     * CallerID verification server error
     */
    const CALLERID_VERIFICATION_ERROR = 18;
    /**
     * ACD failed
     */
    const ACD_FAILED = 19;
     ...
     */
    const PHONE_PROVIDER_FAILED = 20;
    /**
     * Call service failed
     */
    const CALL_SERVICE_FAILED = 21;
    /**
     * Conference balancer error
     */
    const CONFERENCE_BALANCER_ERROR = 22;
    /**
     * Conference server error
     */
    const CONFERENCE_SERVER_ERROR = 23;
    /**
     * Authorization failed
     */
    const AUTHORIZATION_FAILED = 100;
    /**
     * Invalid arguments
     */
    const INVALID_ARGUMENTS = 101;
    /**
     * Missing 'cmd' parameter
     */
    const MISSING_CMD = 102;
    /**
     * Unknown command
     */
    const UNKNOWN_COMMAND = 103;
    /**
     * Forbidden command
     */
    const FORBIDDEN_COMMAND = 104;
    /**
     * The required output format type is not supported
     */
    const REQUIRED_OUTPUT_FORMAT_TYPE_IS_NOT_SUPPORTED = 105;
    /**
     * Account's name isn't unique
     */
    const ACCOUNTS_NAME_ALREADY_USED = 106;
    /**
     * Invalid application name
     */
    const INVALID_APPLICATION_NAME = 107;
    /**
     * Exceeded the application count limit per account
     */
    const APPLICATION_COUNT_EXCEEDED = 108;
    /**
     * Exceeded the user count limit per account
     */
    const USER_COUNT_EXCEEDED = 109;
    /**
     * Invalid plan
     */
    const INVALID_PLAN = 110;
    /**
     * Invalid date format
     */
    const INVALID_DATE_FORMAT = 111;
    /**
     * The password must be at least 6 characters long
     */
    const PASSWORD_LENGTH = 112;
    /**
     * Account's name must be at least 5 and up to 20 characters long
     */
    const ACCOUNT_NAME_LENGTH = 113;
    /**
     * Account's name should start with a letter and can contain latin characters, digits, hyphen
     */
    const ACCOUNT_NAME_INITIAL_LETTER = 114;
    /**
     * The 'account_id' parameter is invalid
     */
    const INVALID_ACCOUNT_ID = 115;
    /**
     * The 'application_id' parameter is invalid
     */
    const INVALID_APPLICATION_ID = 116;
    /**
     * The 'user_id' parameter is invalid
     */
    const INVALID_USER_ID = 117;
    /**
     * The user name isn't unique
     */
    const USER_NAME_ISNT_UNIQUE = 118;
    /**
     * Invalid phone number
     */
    const INVALID_PHONE_NUMBER = 121;
    /**
     ...
     */
    const USER_NAME_RESTRICTIONS = 122;
    /**
     * Invalid date range
     */
    const INVALID_DATE_RANGE = 123;
    /**
     * Invalid money amount
     */
    const INVALID_MONEY_AMOUNT = 125;
    /**
     * Insufficient money
     */
    const INSUFFICIENT_MONEY = 127;
    /**
     * Account's email isn't unique
     */
    const ACCOUNTS_EMAIL_ISNT_UNIQUE = 128;
    /**
     * Application name isn't unique
     */
    const APPLICATION_NAME_ISNT_UNIQUE = 129;
    /**
     * The script text is too long
     */
    const SCRIPT_TEXT_IS_TOO_LONG = 130;
    /**
     * The account isn't activated
     */
    const ACCOUNT_ISNT_ACTIVATED = 131;
    /**
     * The 'scenario_id' parameter is invalid
     */
    const INVALID_SCENARIO_ID = 132;
    /**
     * The scenario name isn't unique
     */
    const SCENARIO_NAME_ISNT_UNIQUE = 133;
    /**
     * Required parameter is empty
     */
    const REQUIRED_IS_EMPTY = 134;
    /**
     * Session timeout
     */
    const SESSION_TIMEOUT = 135;
    /**
     * Invalid email
     */
    const INVALID_EMAIL = 136;
    /**
     * The account isn't logged
     */
    const ACCOUNT_ISNT_LOGGED = 137;
    /**
     * Activation is over for the phone number
     */
    const ACTIVATION_IS_OVER_FOR_THE_PHONE_NUMBER = 139;
    /**
     * Exceeded the max SMS code entering attempts
     */
    const EXCEEDED_THE_MAX_SMS_CODE_ENTERING_ATTEMPTS = 140;
    /**
     * The 'sms_code' parameter is invalid
     */
    const INVALID_SMS_CODE = 141;
    /**
     * Activation is not required
     */
    const ACTIVATION_IS_NOT_REQUIRED = 142;
    /**
     * The 'rule_id' parameter is invalid
     */
    const INVALID_RULE_ID = 147;
    /**
     * The 'rule_pattern' parameter is invalid
     */
    const INVALID_RULE_PATTERN = 148;
    /**
     * The 'rule_pattern_exclude' parameter is invalid
     */
    const INVALID_RULE_PATTERN_EXCLUDE = 149;
    /**
     * The 'call_session_history_id' parameter is invalid
     */
    const INVALID_CALL_SESSION_HISTORY_ID = 150;
    /**
     * Rejected payment request
     */
    const REJECTED_PAYMENT_REQUEST = 151;
    /**
     * No bank card
     */
    const NO_BANK_CARD = 152;
    /**
     * The card payment amount must be greater than 10$
     */
    const CARD_PAYMENT_AMOUNT_MUST_BE_GREATER_THAN_10 = 153;
    /**
     * The 'min_balance' must be greater than 1 $
     */
    const MIN_BALANCE_MUST_BE_GREATER_THAN_1 = 154;
    /**
     * The 'card_overrun_value' must be greater than 10$
     */
    const CARD_OVERRUN_VALUE_MUST_BE_GREATER_THAN_10 = 155;
    /**
     * The 'rule_name' parameter is invalid
     */
    const INVALID_RULE_NAME = 156;
    /**
     * The 'user_display_name' parameter is invalid
     */
    const INVALID_USER_DISPLAY_NAME = 157;
    /**
     * The 'card_holder' parameter is invalid
     */
    const INVALID_CARD_HOLDER = 158;
    /**
     * The 'acct' parameter is invalid
     */
    const INVALID_ACCT = 159;
    /**
     * The 'cvv' parameter is invalid
     */
    const INVALID_CVV = 160;
    /**
     * The 'session_id' parameter is invalid
     */
    const INVALID_SESSION_ID = 161;
    /**
     * try later..
     */
    const TRY_LATER = 162;
     ...
     */
    const INVALID_RANGE = 497;
    /**
     * Agent can be assigned up to 5 skills
     */
    const MAX_AGENT_SKILLS_EXCEEDED = 498;
    /**
     ...
     */
    const INVALID_PARTNER_CODE_LENGTH = 500;
    /**
     * File not found.
     */
     ...
     */
    const NO_ROUTE_FOR_DST_NUMBERS = 506;
    /**
     * The 'src_number' parameter is invalid.
     */
    const INVALID_SRC_NUMBER = 507;
    /**
     * The 'text' parameter is invalid.
     */
    const INVALID_TEXT = 508;
    /**
     * A2P SMS disabled for number %1$s
     */
    const A2P_SMS_DISABLED = 509;
    /**
     * Registration incomplete
     */
    const REGISTRATION_INCOMPLETE = 511;
    /**
     ...
     */
    const SAME_OPERATION_LIMIT = 515;
    /**
     * Payment in progress.
     */
    const PAYMENT_IN_PROGRESS = 516;
    /**
     * The combined length of the '%1$s' and '%2$s' parameters can't be less than 6 characters.
     */
    const INSUFFICIENT_PASSPORT_DATA_LENGTH = 517;
    /**
