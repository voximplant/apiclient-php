...
interface RulesInterface
{
    ...
    /**
     * @method Configures the rules' order in the <a href='//manage.voximplant.com/applications'>Applications</a> section of Control panel. Note: the rules should belong to the same application!
     */
